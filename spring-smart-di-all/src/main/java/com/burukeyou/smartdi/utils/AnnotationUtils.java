...
public abstract class AnnotationUtils {
    ...
    public static AnnotationMeta getAnnotationMeta(AnnotatedElement annotatedElement,
        ...
        if (tryMergedAnnotation) {
            annotation = tryGetMergedAnnotation(annotatedElement, annotationType);
            if (annotation != null){
                attributes = getAnnotationAttributes(annotation, propertyResolver, ignoreDefaultValue, ignoreAttributeNames);
            }
        }
